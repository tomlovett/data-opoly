...
// factory
	// data input
	// process each tile from raw data to hexadecimal color
	// send up data-set
	// calc upper and lower bounds of normalize
		// normalize individual tiles to bounds
		// normVal = (val - min)/(max - min)
	// convert number to color
		// value.toString(16)

var rawDataToColorSet = function(rawData) {
