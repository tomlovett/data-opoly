...
DataOpoly.factory('preloads', function() {
	...
	var topRow = _.map([21, 22, 23, 24, 25, 26, 27, 28, 29], function(index) {
		return tiles[index]
	})
	...
	var bottomRow = _.map([9, 8, 7, 6, 5, 4, 3, 2, 1], function(index) {
		return tiles[index]
	})
